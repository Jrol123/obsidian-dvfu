...
$$
\begin{cases}
\alpha_{1} + \alpha_{1} t + \beta_{1} = -\alpha_{1} t - \beta_{1} + \alpha_{2}t + \beta_{2} - 2\alpha_{3}t - 2\beta_{3} & \alpha_{1} = -2\alpha_{1}t + -\beta_{1} + \alpha_{2}t + \beta_{2} - 2\alpha_{3}t - 2\beta_{3} \\
\alpha_{2} + \alpha_{2}t + \beta_{2} = 4\alpha_{1}t + 4\beta_{1} + \alpha_{2}t + \beta_{2} & \alpha_{2} = 4\alpha_{1}t + 4\beta_{1} \\
\alpha_{3} + \alpha_{3}t + \beta_{3} = 2\alpha_{1}t + 2\beta_{1}t + \alpha_{2}t + \beta_{2} - \alpha_{3}t - \beta_{3} & \alpha_{3} = 2\alpha_{1}t + 2\beta_{1}
\end{cases}
$$
## Ответ
# №810~
