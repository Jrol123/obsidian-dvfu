...
$$
\begin{cases}
-B_{2} = 2B_{1} - 3B_{2} - 2B_{1} + 4B_{2} + 2 & B_{2} = -1 \\
A_{1} = -4A_{1} + 6A_{2} + 3 & 5A_{1} = 6A_{2} + 3 \\
-B_{1} = \frac{12}{5}A_{2} + \frac{6}{5} - 3A_{2} & -5B_{1} = 9A_{2} + 6 \\
A_{2} = -\frac{9}{5}A_{2} - \frac{6}{5} + 2 & \frac{14}{5}A_{2} = -\frac{4}{5} & 7A_{2} = -2
\end{cases}
$$
## Ответ
