...
$$
P' = \begin{pmatrix}
\left( A_{1}t + B_{1} \right)e^{t} + A 
\end{pmatrix}
$$
$$
\begin{cases}
2A_{1}t + B_{1} = 2A_{1}t^{2} + 2B_{1}t + 2K_{1} - 4A_{2}t^{2} - 4B_{2}t - 4K_{2} \\
2A_{2}t + B_{2} = A_{1}t^{2} + B_{1}t + K_{1} - 3A_{2}t^{2} - 3B_{2}t - 3K_{2} + 3e^{t}
\end{cases}
$$
## Ответ
