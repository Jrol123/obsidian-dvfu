...
**Утверждение 1**
	$\sqsupset = \text{diag}\left\{ \mathcal{G}_{0}, \mathcal{G}_{1}, \ldots, \mathcal{G}_{q} \right\}$
	$e^{t\mathcal{G}} = \text{diag}\left\{ e^{t\mathcal{G})}, e^{t\mathcal{G}_{1}}, \ldots, e^{t\mathcal{G}_{q}} \right\}$