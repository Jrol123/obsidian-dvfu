...
$\left\| \phi^{j + 1} \right\| = \left\| T^{j}\phi^{j} + \tau S^{j}f^{j} \right\| \leq \left\| T^{j}\phi^{j} \right\| + \tau \left\| S^{j}f^{j} \right\| \leq \left\| \phi^{j} \right\| + \tau \left\| f^{j} \right\| \leq \left\| g \right\| + \tau \left\| f^{j} \right\|$
