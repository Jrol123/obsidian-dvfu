...
$\left\|(E + \sigma A)^{-1}\right\| = \max\limits_{\psi} \sqrt{ \dfrac{\left[ \psi, \psi \right]}{\left[ (E + \sigma A)\psi, (E + \sigma A)\psi \right]} } = \max\limits_{\psi} \sqrt{ \dfrac{(\psi, \psi)}{(\psi, \psi) + 2\sigma(A\psi, \psi) + \sigma^2(A\psi, A\psi)} } \le 1$
