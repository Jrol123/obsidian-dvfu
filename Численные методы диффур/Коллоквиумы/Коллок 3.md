...
**Доказательство v1**
Домножим обе части с обеих сторон на $\left( E + \frac{\tau}{2}A \right)$
$\left( E - \frac{\tau}{2}A \right)\left( E + \frac{\tau}{2}A \right) = \left( E + \frac{\tau}{2}A \right)\left( E - \frac{\tau}{2}A \right) = E - \left( \frac{\tau}{2} \right)^{2}A^{2}$
Ч. Т. Д.
