...
$\left\| T^{j} \right\| \leq 1$ (см. 3-й вопрос)
$||\phi^{j+1}|| \le \|T^j\|\cdot||\phi^j|| + \tau\underset{\le 1}{\left|\left|\left(E + \dfrac{\tau}{2} \Lambda^j\right)^{-1} \right|\right|} \cdot ||f^j|| \le ||\phi^j|| + \tau||f^j|| \le$
