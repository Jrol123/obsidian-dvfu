...
$L_{\tau}\phi = \frac{1}{\tau}\left[ \tau\phi' + \dfrac{\tau^{2}}{2}\left( \phi^{j} \right)'' + O\left( \tau^{3} \right) \right] + \dfrac{A}{2} \left[ 2\phi + \tau\phi' + \dfrac{\tau^{2}}{2}\phi'' + O\left( \tau^{3} \right) \right]$
