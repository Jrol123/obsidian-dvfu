...
$\left\| \phi^{j + 1} \right\| = \left\| T^{j}\phi^{j} + \tau S^{j}f^{j} \right\| \leq \left\| T^{j}\phi^{j} \right\| + \tau \left\| S^{j}f^{j} \right\| \leq \left\| \phi^{j} \right\| + \tau \left\| f^{j} \right\| \leq \left\| g \right\| + \tau \cdot j\cdot \left\| f^{j} \right\|$

$||\phi^{j+1}|| \le \|T^j\|\cdot||\phi^j|| + \tau \left\| S^{j} \right\| \cdot \left\| f^j \right\| \le ||\phi^j|| + \tau||f^j|| \le \ldots \le \left\| g \right\| + \tau j \left\| f^j \right\|$
