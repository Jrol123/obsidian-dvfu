...
$\phi^{j+1} = \left(E + \dfrac{\tau}{2}\Lambda_1^j\right)^{-1}\left(E - \dfrac{\tau}{2}\Lambda_1^j\right)\phi^{j+\frac{1}{2}} \implies$
$\implies \phi^{j+1} = \left(E + \dfrac{\tau}{2}\Lambda_1^j\right)^{-1}\left(E - \dfrac{\tau}{2}\Lambda_1^j\right)\left(E + \dfrac{\tau}{2}\Lambda_1^j\right)^{-1}\left(E - \dfrac{\tau}{2}\Lambda_1^j\right)\phi^j$

$T^j = \left(E + \dfrac{\tau}{2}\Lambda_1^j\right)^{-1}\left(E - \dfrac{\tau}{2}\Lambda_1^j\right)\left(E + \dfrac{\tau}{2}\Lambda_1^j\right)^{-1}\left(E - \dfrac{\tau}{2}\Lambda_1^j\right)$
