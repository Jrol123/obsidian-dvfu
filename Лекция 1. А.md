...
**Фундаментальная последовательность**
	$(X, \rho)$ - метрическое прос~~т~~ранство
	$\{x_j \}\subset X$ - фундаментальная $\iff \rho(x_j, x_k)\to 0\quad j, k \to \infty$
	
**Полное пространство**
	$\left( X, \rho \right)$ - метрическое пространство
	Если $\forall$ фундаментальная $\left\{ x_{j} \right\}$ - сходится

**Принцип сжимающих отображений**
	$X-$ пмп (?), $K\subset X$
	$A:K\to X: \forall x_1, x_2 \in K\quad \rho(Ax_1,Ax_2)\le q \rho(x_1, x_2)\quad q\in (0,)$
