...
**При $\dfrac{3}{2} \lt p \lt \infty$**
	$\left\| g \right\|_{q} = \left( \int \limits_{ -1 }^{ 1 } \left| s \right|^{-\frac{q}{3}} ds \right)^{\frac{1}{q}} = \left( 2\int \limits_{ -1 }^{ 1 }s^{-\frac{q}{3}} ds \right)^{\frac{1}{q}} = \left( \dfrac{6s^{1 - \frac{q}{3}}}{3 - q} \right)^{\frac{1}{q}}$
