...
$\dfrac{\rho \left( x, y \right)}{1 + \rho \left( x, y \right)} \leq \dfrac{\rho \left( x, z \right) + \rho \left( z, y \right)}{1 + \rho \left( x, z \right) + \rho \left( z, y \right)} \leq \dfrac{\rho \left( x, z \right)}{1 + }$
