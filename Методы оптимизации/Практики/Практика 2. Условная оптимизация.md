...
$f_{1}(x_{1}, x_{2}) = f_{1}(x_{1}^{k}, x_{2}^{k}) + \nabla f_{1}(x_{k})(x - x_{k}) = f_{1}(x_{1}^{k}, x_{2}^{k}) + \left( \dfrac{\partial f_{1}}{\partial x_{1}}(x_{1}^{k}, x_{2}^{k}), \dfrac{\partial f_{1}}{\partial x_{2}}\left( x_{1}^{k}, x_{2}^{k} \right) \right)$