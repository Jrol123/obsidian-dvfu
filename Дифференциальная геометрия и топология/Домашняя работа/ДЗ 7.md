...
$V=(\min(\mathbb{Q})-\epsilon_1; \max(\mathbb{Q})+\epsilon_2)$
...
Значит $\forall B\in Y\quad f|Q^{-1}(B)\in \{ \emptyset, \mathbb{Q} \}\quad f|R\backslash Q^{-1}(B)\in \{ \emptyset, \mathbb{R}\backslash \mathbb{Q} \}$
