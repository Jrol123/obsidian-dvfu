...
$\left[ \overline v, \overline n \right] = \frac{\cos(t)}{\sqrt{ 2 }} \cdot \left( -\sin(t) \right) + \frac{\sin(t)}{\sqrt{ 2 }}\cdot \cos(t), -\frac{\sin(t)}{\sqrt{ 2 }}\cdot_{0} - \frac{1}{\sqrt{ 2 }}\cdot \left( -\sin(t) \right), \frac{1}{\sqrt{ 2 }}\cdot \frac{\cos(t)}{\sqrt{ 2 }} - \cos$
