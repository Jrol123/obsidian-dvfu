...
$F = A \backslash(A \cap U) = A \cap \left( X \backslash U \right)$
	$A \cap B = \left\{ x | x \in A \text{ and } B \right\}$
	$A \backslash B = \left\{ x | x \in A,\ x \cancel{ \in } B \right\}$
	$A \backslash \left( A \cap B \right) = \left\{ x |x \in A,  x \cancel{ \in } A \text{ and } B \right\}$
