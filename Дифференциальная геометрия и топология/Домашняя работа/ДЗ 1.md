...
$$\begin{cases}
b_{1} = a_{1} \cdot c_{1}^1 + a_{2} \cdot c_{1}^2 + a_{3} \cdot c_{1}^3 \\
b_{2} = a_{1} \cdot c_{2}^1 + a_{2} \cdot c_{2}^2+   a_{3} \cdot c_{2}^3 \\
b_{3} = a_{1} \cdot c_{3}^1 +a_{2} \cdot c_{3}^2 + a_{3} \cdot c_{3}^3
\end{cases}
$$
