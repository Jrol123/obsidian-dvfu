...
$$\begin{cases}
b_{i1} = a_{11} \cdot c_{1i} + a_{12} \cdot c_{2i} + a_{13} \cdot c_{3i} \\
b_{i2} = a_{21} \cdot c_{1i} + a_{22} \cdot c_{2i} + a_{23} \cdot c_{3i} \\
b_{i3} = a_{31} \cdot c_{1i} + a_{32} \cdot c_{2i} + a_{33} \cdot c_{3i}
\end{cases}
$$
