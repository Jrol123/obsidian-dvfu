...
$(\impliedby):$
$(\forall U \in T\ \forall x \in U\ \exists V \in \mathfrak S : \quad x \in V \subset U) \implies \exists I \subset \mathbb{N}:\ V_{i} \subset U$
$\implies \forall U in T\ \exists I \subset \mathbb{N}:$