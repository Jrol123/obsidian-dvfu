...
$A \neq \emptyset  \quad A \neq X \quad A \cancel{ \in } T$

Возьмём $U \in T \quad \forall U \neq \emptyset,\ U \in X \backslash A$, так как иначе $Int\left( X \backslash A \right) = \emptyset$ и $Cl(Int(X \backslash A)) = \emptyset \neq X$
