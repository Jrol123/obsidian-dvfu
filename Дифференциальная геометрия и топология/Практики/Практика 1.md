...
$\forall k \in \mathbb{Z},  \neq \pm 1 \quad \exists p \in \mathbb{P}$, где $p|k$ ==($\text{некоторое число} k\ \text{делится нацело на}\ p$)==
$\mathbb{Z} \backslash \{ 1,-1 \} = \underset{p \in \mathbb{P}} \cup N_{0, p}$ - замкнутое, конечное *(конечное, т. к. $\mathbb{P}$ - конечно)*
**НО!**
