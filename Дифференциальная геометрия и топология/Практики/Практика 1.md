...
$T_{3} = \{ \emptyset, \{ 0 \}, \{ 0, 1 \} \}$
$T_{4} = \{ \emptyset, \{ 1 \}, \{ 0, 1 \} \}$
<mark style="background: #FF5582A6;">$T = \{ \emptyset, \{ 0 \}, \{ 1 \} \}$; - НЕ ТОПОЛОГИЯ</mark>
<mark style="background: #000000;">Марк</mark>
...
1. $(X, \text{дискретная топология})$
	...
	$B_{n} = B_{1} \cup \{ U \} \quad U \subsetq X$
2. $(X, \text{антидискретная топология})$
	$B = \{ x \}$
3. $X = [0, + \infty) \subsetq R$
	$T = \{ \emptyset \} \cup$