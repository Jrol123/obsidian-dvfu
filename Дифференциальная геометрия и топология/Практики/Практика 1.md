...
$\mathbb{Z} \backslash \{ 1,-1 \} = \underset{p \in \mathbb{P}} \cup N_{0, p}$ - замкнутое, конечное *(конечное, т. к. $\mathbb{P}$ - конечно)* (конечное число объединений замкнутых множеств замкнуто)
**НО!**
