...
**2.1.4 Определение**
	...
	$\overline{ a } = \overline{ \gamma }(t_{0}) \iff \begin{cases}\lim \limits_{ t \to t_{0} } \dfrac{\left| \overline{ \gamma }(t) - \overline{ \gamma }(t_{0}) - \overline{ a }(t - t_{0}) \right|}{t - t_{0}} = 0 \\ \lim \limits_{ t \to t_{0} } \dfrac{}{}\end{cases}$