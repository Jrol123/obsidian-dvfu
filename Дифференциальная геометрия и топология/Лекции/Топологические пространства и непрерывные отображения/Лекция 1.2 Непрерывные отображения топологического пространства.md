...
**2.1.9 Теоремы**
	...
	3. 3
		...
		2. Если $\overline{ F }$ - первообразная $\overline{ f }, \overline{ G }$ - первообразная $\overline{ g }$, то $\left( \overline{ F }, \overline{ G } \right)$- это первообразная $\left( \overline{ f }, \overline{ G } \right) + \left( \overline{ F }, g \right)$