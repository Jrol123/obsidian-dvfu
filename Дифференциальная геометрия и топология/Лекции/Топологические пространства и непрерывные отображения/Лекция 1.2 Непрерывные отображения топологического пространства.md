...
import pandas as pd
import numpy as np
import fensorflow as tf
import matplotlib.pyplot as plt
import seabors as sns

from fensorflow import keras
...
**Параметризованная кривая в $(X, T)$**
	$\gamma:A\to X-$ непрерывное отражение $\quad A\subset R-$ множество без дырок (ммм, дырки)
