...
**Доказательство**
	 ...
	 **"В частности"**
		...
		Таким образом, $PB$ - предбаза топологии $R$, поэтому основная часть теоремы [[#^74b747|1.2.9]] для доказательства непрерывности $f$ достаточно установитьЮ что $f^{-1}(- \infty, a)$ и $f^{-1}(b, +\infty)$
