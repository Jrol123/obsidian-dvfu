...
$w'' = \dfrac{2x + 1}{a}$
$w\left( x \right) = \dfrac{x^{3}}{3a} + \dfrac{x^{2}}{2a} + C_{1}x + C_{2}$
$\begin{cases} w\left( 0 \right) = C_{2} = 1 \\ w\left( 1 \right) = \dfrac{5}{6a} + C_{1} + C_{2} = 2 \end{cases} \implies \begin{cases} C_{2} = 1 \\ C_{1} = 1 - \dfrac{5}{6a} \end{cases}$
$w\left( x \right) = \dfrac{x^{3}}{3a} + \dfrac{x^{2}}{2a} + \left( 1 - \dfrac{5}{6a} \right)x + 1$

$u_{t} = v_{t} + 0$
$u_{x} = v_{x} + \dfrac{x^{2}}{a} + \dfrac{x}{a} + C_{1}$
$u_{xx} = v_{xx} + \dfrac{2x + 1}{a}$

$\begin{cases} u_{t} = v_{t} = a^{2} \cdot \left( v_{xx} + \dfrac{2x + 1}{a} \right) + 2x + 1 \\ u\left( 0, t \right) = v\left( 0, t \right) + 1 = 1 \\ u\left( 1, t \right) = v\left( 1, t \right) + \dfrac{5}{6a} + 1 - \dfrac{5}{6a} + 1 = 2 \\ u\left( x, 0 \right) = v\left( x, 0 \right) = \dfrac{2x^{3} + 3x^{2}}{6a} + \left( 1 - \dfrac{5}{6a} \right)x + 1 = x + 1 \end{cases}$
