...
$\begin{cases} u_{t} = v_{t} = a^{2} \cdot \left( v_{xx} + \dfrac{2x + 1}{a} \right) + 2x + 1 \\ u\left( 0, t \right) = v\left( 0, t \right) + 1 = 1 \\ u\left( 1, t \right) = v\left( 1, t \right) + \dfrac{5}{6a} + 1 - \dfrac{5}{6a} + 1 \end{cases}$
