...
$T' + \left( n\pi \right)^{2}T = 0$
$\dfrac{T'}{T} = -\left( n\pi \right)^{2}$
$\dfrac{dT}{T} = -\left( n\pi \right)^{2}dt$
$\ln \left( T \right) = -\left( n\pi \right)^{2} t + C$
$T = \exp \left( C \right) \cdot \exp(-(n\pi)^{2}t)$
$T_{n} = C_{n}\cdot \exp \left( -\left( n\pi \right)^{2}t \right)$

$v_{n}\left( x, t \right) =\alpha _{n}\sin \left( n\pi x \right) \cdot \exp \left( -\left( n\pi \right)^{2} t \right)$
