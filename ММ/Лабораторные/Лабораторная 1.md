...
Практическим итогом работы стала успешная реализация алгоритмов для подбора параметров моделей и построения прогнозов на основе реальных данных, а также доказательство теоретического утверждения об отсутствии периодических решений в автономных системах.
