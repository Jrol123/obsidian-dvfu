...
$$
\cases{
{k_{1}\left( h \right) = hf \left( x, y \right) } \\
{k_{2}\left( h \right) = hf\left( x + \alpha_{2}h, y + \beta_{2}, k_{1}\left( h \right)  \right) } \\
{\ldots} \\
{k_q(h)=h\cdot f(x+\alpha_q\cdot h, y+\beta_{q,1} \cdot k(h)+\ldots +\beta_{q,q-1}\cdot k_{q-1})}
}
$$
