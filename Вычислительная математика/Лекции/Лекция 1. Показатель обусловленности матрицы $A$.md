**Число обусловленности матрицы $A$**.
	...
	Число обусловленности отражает, насколько функция чувствительна к изменениям или ошибкам на входе и насколько ошибка на выходе является результатом ошибки на входе.
$$
