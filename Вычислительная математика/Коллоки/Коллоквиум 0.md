...
$$
\begin{cases}
{k=A_{i-1}^{-1}\cdot \left( kE+BCA_{i-1} \right)} \\
{B_{i-1} = (A_{i-1}-\dfrac{1}{a_{22}} \cdot a_{12}\cdot a_{21})^{-1}} \\
{b_{12}=-\dfrac{1}{a_{22}} \cdot B_{i-1}\cdot a_{12}} \\
{b_{21}=-\dfrac{1}{a_{22}} \cdot a_{21}\cdot B_{i-1}} \\
{b_{22}=\dfrac{1}{a_{22}}(1-a_{21}\cdot b_{12})}
\end{cases}
$$
