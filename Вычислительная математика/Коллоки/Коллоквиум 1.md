...
$F(y) = \left( A\left( y - x^{*} \right), y - x^{*} \right) - \left( Ax^{*}, x^{*} \right) = \left( Ay, y \right) - \left( Ax^{*}, y \right) - \left( Ay, x^{*} \right) + \left( Ax^{*}, x^{*} \right) - \left( Ax^{*}, x^{*} \right) = \left( Ay, y \right) - 2\left( Ax^{*}, y \right)$
