...
$$\tan 2\pi = \dfrac{x}{y} = \dfrac{\dfrac{\operatorname{sign}(xy)|x|}{\sqrt{x^2 + y^2}}}{\dfrac{|y|}{\sqrt{x^2 + y^2}}} = \dfrac{\overline{s}}{\overline{c}} \tag{1}$$
...
$2c^2 - 1 = \dfrac{|y|}{\sqrt{x^2 + y^2}}, 2sc = \dfrac{\operatorname{sign}(xy)|x|}{\sqrt{x^2 + y^2}}$ 

Из первого из них получаем $c = \sqrt{\dfrac{1}{2} \left(1 + \dfrac{|y|}{\sqrt{x^2 + y^2}}\right)}$,
и второго $s = \dfrac{\operatorname{sign}(xy)|x|}{2c\sqrt{x^2 + y^2}}$.
