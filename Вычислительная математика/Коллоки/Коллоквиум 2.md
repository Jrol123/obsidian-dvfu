...
$$ \begin{pmatrix}1 &0&&&&&&& 0 \\ 0& \dots &&&&&&0 \\ && c && \ldots  & & -s\\ && \vdots & 1 &&&\vdots \\ &&&& \ldots && \\ &&\vdots &&& 1 &\vdots \\ &&s &&\ldots && c \\ & 0 & &&&&&\ldots & 0 \\ 0 &&&&&&& 0 & 1 \end{pmatrix} \begin{matrix}\\\\ l\text{-ая строка} \\\\\\\\\\ m\text{-ая строка} \\\\ \end{matrix}$$
