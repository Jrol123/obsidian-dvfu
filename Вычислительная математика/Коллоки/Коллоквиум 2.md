...
На первом шаге находим индексы $l_1, m_1$ максимального по модулю наддиагонального элемента $A$, строим матрицу вращения $C_1 = C_{l_1 m_1}$ с определёнными выше опорными элементами, и вычисляем матрицу $A_1 = C_1^T AC_{1 m_1}$.
