...
$\begin{matrix}A = Q_1 R_1 &, & A_1 = R_1 Q_1, \\ A_1 = Q_2 R_2 &, & A_2 = R_2 Q_2,\\ \ldots && \ldots \\ A_{k-1} = Q_k R_k &, & A_k = R_k Q_k, \\ \ldots && \ldots\end{matrix}$
, где все $Q_i$ ортогональны, а $R_i$ невырожденные верхнетреугольные.
