...
Также это означает, что $A_k$ стремится к диагональной матрице, которую обозначим через $\Lambda$. Так как $A_k$ подобна $A$, то и $\Lambda$ подобна $A$, т. е. на диагонали $\Lambda$ стоят собственные значенм
